...
# 추가로 뽑고 싶은 특정 지표들
other_metrics = ['_step','loss_scaled', 'grad_norm', 'loss_tgt_mean']
output_filename = "A2_runs_metrics.jsonl"
...
if run_count > 0:
    ...
    print("\n❌ 조건에 맞는 Run('A1' 시작)을 찾지 못했어. 프로젝트나 런 이름을 확인해 줘.")